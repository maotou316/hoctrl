...
def update_firestore(model, version, download_url, changelog, min_version):
    ...
    try:
        ...
        try:
            ...
            return update_firestore(model, version, download_url, changelog, min_version)
...
def main():
    ...
    # 更新 Firestore
    firestore_ok = update_firestore(model, version, download_url, changelog, args.min_version)
