...
// 根據 RELAY_PIN 自動決定設備型號
#if RELAY_PIN == 7
const char* deviceModel = "hoRelay2-1"; // 新版 (GPIO 7)
#else
const char* deviceModel = "hoRelay2";   // 舊版 (GPIO 4)
#endif
...
const int relayButton = RELAY_PIN;      // MOSFET 控制腳位
...
void setup()
{
  ...
  // 設定並關閉內建 LED
  pinMode(ledOnBoard, OUTPUT);  // 初始化LED腳位
